...
The workflows publish only bounded result or sanitized failure-diagnostic artifacts and have no automatic trigger. The currently authorized payload is Rivetkind v1.38 build 39.
