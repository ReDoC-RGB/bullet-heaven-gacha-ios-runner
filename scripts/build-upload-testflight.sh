...
readonly EXPECTED_VERSION="1.117"
readonly EXPECTED_BUILD="118"
...
assert set(x)=={'schema','archiveSha256','archiveByteLength','manifestSha256','manifestByteLength','inventoryCount','framedTreeSha256','candidateCommit','candidateTree'}
expected={
...
assert info['CFBundleShortVersionString']=='1.117' and str(info['CFBundleVersion'])=='118'
...
x={
 ...
 'bundleIdentifier':'com.wellmadesystems.bulletheavengacha.audition','versionName':'1.117','buildNumber':118,
...
printf 'PASS Rivetkind 1.117 build 118 uploaded to Apple TestFlight processing\n'
